defmodule BibtimeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BibtimeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BibtimeWeb.Gettext, "errors", msg, opts)
    end
  end
