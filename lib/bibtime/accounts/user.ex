defmodule Bibtime.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Bibtime.Repo)
  ...
  """
  def valid_password?(%Bibtime.Accounts.User{hashed_password: hashed_password}, password)
