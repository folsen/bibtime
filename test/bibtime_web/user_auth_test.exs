defmodule BibtimeWeb.UserAuthTest do
  use BibtimeWeb.ConnCase

  alias Bibtime.Accounts
  alias Bibtime.Accounts.Scope
  alias BibtimeWeb.UserAuth

  import Bibtime.AccountsFixtures

  @remember_me_cookie "_bibtime_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BibtimeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
